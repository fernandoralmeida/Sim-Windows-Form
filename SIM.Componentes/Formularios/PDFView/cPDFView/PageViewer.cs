...
namespace Sim.Forms.cPDFView
{
    public partial class PageViewer : UserControl
    {
        ...
        public Point ClientToPage(Point p)
        {
            ...
            Point pp = new Point(Margin.Left, Margin.Top);
            return pp;
        }
    ...
    public class ShadowDrawing
    {
        ...
        static Image shadowDownRight = new Bitmap(Sim.Componentes.Properties.Resources.tshadowdownright);
        static Image shadowDownLeft = new Bitmap(Sim.Componentes.Properties.Resources.tshadowdownleft);
        static Image shadowDown = new Bitmap(Sim.Componentes.Properties.Resources.tshadowdown);
        static Image shadowRight = new Bitmap(Sim.Componentes.Properties.Resources.tshadowright);
        static Image shadowTopRight = new Bitmap(Sim.Componentes.Properties.Resources.tshadowtopright);
