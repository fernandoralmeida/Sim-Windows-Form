...
namespace Sim.WpfLibrary
{
    public static class ThemeManager
    {
        public static ResourceDictionary GetThemeResourceDictionary(string theme)
        {
            if (theme != null)
            {
                Assembly assembly = Assembly.LoadFrom("Sim.WpfLibrary.dll");
                string packUri = String.Format(@"/Sim.WpfLibrary;component/{0}/DataGridStyle.xaml", theme);
